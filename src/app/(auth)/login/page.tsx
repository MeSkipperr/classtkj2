...
import  MakeCoockieLogin  from '@/function/makeCookieLogin';
import { useRouter } from 'next/navigation';

interface AuthResult {
    success: boolean;
    userNameData?: string; // Opsional karena mungkin tidak selalu ada
}
...
const Login = () => {
    ...
    const [response, setResponse] = useState<AuthResult>();
